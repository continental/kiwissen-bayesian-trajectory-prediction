...
Based on https://github.com/google/uncertainty-baselines/blob/main/uncertainty_baselines/models/resnet50_variational.py
...
def bottleneck_block(
    ...
    # stddev as sqrt(2 / fan_in) (as is done for the stddev in He
    # initialization).
